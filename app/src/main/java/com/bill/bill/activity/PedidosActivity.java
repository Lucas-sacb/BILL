...
import com.bill.bill.adapter.AdapterPedido;
import com.bill.bill.adapter.AdapterProduto;
import com.bill.bill.helper.ConfiguracaoFirebase;
import com.bill.bill.helper.UsuarioFirebase;
import com.bill.bill.listener.RecyclerItemClickListener;
import com.bill.bill.model.Pedido;
...
public class PedidosActivity extends AppCompatActivity {
    ...
    private void recuperarPedidos() {
        ...
        dialog = new SpotsDialog.Builder()
                .setContext(this)
                .setMessage("Carregando dados, por favor aguarde")
                .setCancelable( false )
                .build();
        dialog.show();
